...
st.set_page_config(page_title="AntBot")

st.title("AntBot, an AI of ants")
st.text("Made by Aarush Kaushik")
...
submit = st.button("Get an answer from AntBot")
...
if submit and input_text:
    ...
    if response:
        try:
            ...
            bot_reply = "Sorry, the response was blocked or could not be processed. Please refresh to continue using AntBot"
        
        st.session_state['chat_history'].append(("You", input_text, "AntBot", bot_reply))
